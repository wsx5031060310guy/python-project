...
def capture_camera(mirror=True, size=None):
    ...
    while True:
        ...
        micorwave_state="0"
        try:
            with open(os.getcwd()+"/mamaro/micorwave_value.text", "r+") as f:
                data = f.readlines()
                lines=data[0].split("\n")
        ...
        if micorwave_state=="1":
            ...
            realtime_cam(str(roomid),"https://firebasestorage.googleapis.com/v0/b//o/"+str(tmpfilename)+".jpg?alt=media&token=token",firebase_cam)
