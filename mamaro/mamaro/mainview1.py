...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        #create babybed view
        lbl1 = QtWidgets.QLabel('contentcover1', self)
        lbl1.setObjectName('contentcover1')
        lbl1.setText("")
        lbl1.setCursor(Qt.PointingHandCursor)
        lbl1.setStyleSheet("background: '#EEEEEE';")
        ...
        lbl1.mousePressEvent=self.babybedcontentclick
    ...
    global clickmem
    clickmem=True
    def babybedcontentclick(self, event):
        global clickmem
        try:
            if clickmem:
                ...
                lbl1.hide()
                lbl1 = self.findChild(QtWidgets.QLabel, "contentcover1")
                lbl1.hide()
                clickmem=False
            else:
    ...
    def contentclick(self, event):
        if self.contentlist[self.company_index].url=="Beacon":
            #show ble view
            global clickmem
            try:
                if clickmem:
    ...
    def getdata(self, event):
        ...
        try:
            ...
            try:
                ...
                pass
        self.contentlist.append(company(os.getcwd()+"/mamaro/style/img/QA/170815_2.png","アンケートにご協力ください","some","QA"))
